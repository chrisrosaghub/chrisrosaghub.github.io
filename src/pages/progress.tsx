...
function useChartData(): ChartDatum[] {
  ...
  return useMemo(() => {
    ...
    const completed: Record<SubjectId, Set<string>> = {
      math: new Set(), science: new Set(), history: new Set(), geography: new Set(), reading: new Set(), states: new Set(), presidents: new Set(), language: new Set(), sel: new Set(), memory: new Set(),
    };
